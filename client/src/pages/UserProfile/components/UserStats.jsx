export const UserStats = ({ stats }) => (
  <div className="grid grid-cols-2 gap-4 mb-8 sm:grid-cols-2 md:grid-cols-3">
    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 text-center border border-gray-200 dark:border-gray-700 theme-transition col-span-1">
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 text-center border border-gray-200 dark:border-gray-700 theme-transition col-span-2 md:col-span-1">
